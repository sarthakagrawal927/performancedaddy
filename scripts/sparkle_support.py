...
FEED_URL = "https://performancedaddy.significanthobbies.com/updates/appcast.xml"

def configuration():
    if not PUBLIC_KEY.is_file():
        raise RuntimeError("Sparkle signing is not configured. Generate a dedicated Keychain key with Sparkle's generate_keys --account performancedaddy-updates, then save ONLY its public key to Support/SparklePublicKey.txt.")
